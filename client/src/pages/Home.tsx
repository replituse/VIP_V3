      ...
      <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-20 px-4 md:px-6 text-center">
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-row gap-3 md:gap-4 justify-center w-full max-w-[500px] px-2">
              <Link href="/services" className="flex-1">
                <button className="w-full px-4 md:px-8 py-4 bg-white text-black font-bold rounded-full shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all uppercase text-[10px] md:text-sm tracking-wider flex items-center justify-center cursor-pointer no-default-hover-elevate no-default-active-elevate whitespace-nowrap">
                  Explore Solutions
                </button>
              </Link>
              <Link href="/contact" className="flex-1">
                <button className="w-full px-4 md:px-8 py-4 bg-transparent border-2 border-white text-white font-bold rounded-full hover:bg-white/10 transition-all uppercase text-[10px] md:text-sm tracking-wider flex items-center justify-center cursor-pointer backdrop-blur-sm no-default-hover-elevate no-default-active-elevate whitespace-nowrap">
                  Contact Us
                </button>
              </Link>
            </div>
